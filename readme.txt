...
5. Now that you have obtained the cookie, you can open a command prompt in the downloaded repository folder (right click > open in terminal) and run the command

## Usage

Run the script with the following command-line arguments:

python main.py --asins ASIN1,ASIN2,... --isos ISO1,ISO2,... --cookie COOKIE_STRING [--cookie-source COOKIE_SOURCE] [--start-date START_DATE] [--end-date END_DATE]
